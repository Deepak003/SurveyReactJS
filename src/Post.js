            ...
            <div className="post-grid">
                <div className="post-container">
                    ...
                    <form className="form" onSubmit={this.handleSubmit}>
                        <input required type="text" ref={(input) => this.titleInput = input} placeholder="Enter Title for Survey"
                        /><br /><br />
                        <textarea required ref={(input) => this.messageInput = input} placeholder="Enter Purpose" cols="28" rows="5"></textarea><br />
                        
						<button>Post a Survey</button>
                    </form>
